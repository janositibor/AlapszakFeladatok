package o14_lambdaintermediate;
...
class LongWordsTest {
    ...
    @Test
    void testGetShortestWordAsStringContainingGivenCharacter() {
        assertEquals("körte", longWords.getShortestWordAsStringContainingGivenCharacter('r'));
    }
